...
//			let starTime = this.starttime?this.starttime:'';
//			let endTime = this.endtime?this.endtime:'';
//			let pageSize = 10;
//			let pageNo = this.pageNo;
//			this.ListData = [];
//          api.GetCaseList(status,datasource,fkDepartmenttype,fkPollutiontype,location,starTime,endTime,pageSize,pageNo).then(res =>{
//             //案件列表
//             console.log(res)
...
//	                this.TypeCasesChars(type);
            ...
            InitializationDataMethod(data) {
                ...
                data.forEach(item => {
                    const tableData = {};
                    tableData.time = this.Format(item.createtime);//时间
